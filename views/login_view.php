...
<noscript>
    <div class="js-warning">
        JavaScript ist deaktiviert. Bitte aktiviere JavaScript in deinem Browser, um dich anmelden zu können.
    </div>
</noscript>
...
<?php if (!$cookies_enabled): ?>
    <div class="cookie-warning">
        Cookies sind deaktiviert. Bitte aktiviere Cookies in deinem Browser, um dich anzumelden.
    </div>
<?php endif; ?>
